...
### ⚒️ Use Case
A complete use case scenario is available in the documentation file located at `/resources/docs/1.0/use-case.md`.
Alternatively, you can install the project and navigate to `/docs` in your browser. Then, select the Use Case section from the sidebar menu.
...
- **Use Case** A complete use case scenario
